...
def compare_folders(
    ...
    for file in missing_files1:
        print(f"WARNING:  File missing: '{def_folder2}/{file}'.")
        print(f"          -> Exist:     '{def_folder1}/{file}'.")
    for file in missing_files2:
        print(f"WARNING:  File missing: '{def_folder1}/{file}'.")
    ...
    for file in set(files1.keys()).intersection(set(files2.keys())):
        ...
        if (
            ...
            print(f"ERROR:    File differs:        '{file}'.")
        else:
            print(f"PASS:     Files are identical: '{file}'.")
